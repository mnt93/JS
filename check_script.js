function find_last_url() {
    ...
    while(res!==404){
		...
		url="https://raw.githubusercontent.com/mnt93/JS/main/File_"+year+"_"+S+"_"+file_index2+".js"
		var request = new XMLHttpRequest();
		request.open('GET', url, false);  // `false` makes the request synchronous
		request.send(null);
    	res=request.status;
    ...
    if (file_index2) {
    	url2="https://raw.githubusercontent.com/mnt93/JS/main/File_"+year+"_"+S+"_"+file_index2+".js"
    } else { 
    	url2="";
    }   
...
function check_course_id(id,xml_url) {
  d = new Date();
  date_id="2020-01-01"
