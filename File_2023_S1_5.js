...
function check() {
	...
	while(res!="404: Not Found"){
		file_index=file_index+1;
		url="https://raw.githubusercontent.com/mnt93/JS/main/Date_"+year+"_"+S+"_"+file_index+".txt"
...
function getArray(x,n,rang,Nb_reponses,sci){
	...
	for (j=0;j<Nb_reponses;j++){
    	...
    	document.getElementById("demo").innerHTML = Num_question+'alpha'
    	return reponse
