...
function getArray(x,n,rang,Nb_reponses,sci){
    ...
    function getExprArra(expr, par_var_symb, par_var_val, rang, Nb_reponses) {

        var par_array = math.zeros(Nb_reponses, par_var_val.length).toArray()
        ...
        if (d.getTime() < Date.parse("2022-09-01")) {
            ...
            //document.getElementById("exprf_im_tex").innerHTML ='\\((' + exprf_im_tex + ') i \\)  '
            return reponse
        }
