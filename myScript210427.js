...
function cherche_racine(fonction,y){
	var min=0, max=1, step=0.000001, diff=0.001;
	var xx = min;
	sol=0;
	while(xx <= max && sol==0) {
    		d = fonction(xx)-y;
...
function google_chart_line(x,Y_axis_min,Y_axis_max,X_axis_title,Y_axis_title,curve_name1,curve_name2,Axis_width,Axis_height){
