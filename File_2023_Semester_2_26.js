...
function minus_log_likelihood_x(x) {
  return minus_log_likelihood(x, X, y)
}
...
function Create_Log_Reg_Data(N, beta, mean_X, sigma_X, Col_Names, myrng) {
  ...
  Y = math.subset(data_num, math.index(math.range(0, N), Col_Names.length - 1))
  X = math.subset(data_num, math.index(math.range(0, N), math.range(0, Col_Names.length - 1)))
