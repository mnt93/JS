...
function plot_distribution_plotly(div_id, law, params, x_obs, alpha, side, title, options) {
    ...
    /* ------------------------------------------------------------------ */
        ...
        /* Ordre des couches (bas -> haut) :
           1. Remplissage bleu non-rejet (fill, sans ligne visible)
           2. Hachures (lignes rouges)
           3. Zones de rejet (fill rouge)
           4. Courbe (ligne seule, sans fill)
           5. Lignes verticales x_obs / x_sym                        */
        ...
        /* Couche 2 : hachures par-dessus le bleu */
        traces = traces.concat(hatch_traces);
