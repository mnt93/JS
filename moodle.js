...
function plot_distribution_plotly(div_id, law, params, x_obs, alpha, side, title, options) {
    ...
    if (is_discrete) {
        ...
        while (_lte(k_iter, Math.round(x_max))) {
            ...
            /* Bordure orange pour les barres extremes */
    ...
    /* ------------------------------------------------------------------ */
        ...
        var _add_extreme_zone = function(xa, xb) {
            ...
            if (!xZ.length) return;
            /* Contour orange sans remplissage :
               - cote gauche  : ligne verticale (xa, 0) vers (xa, y(xa))
               - contour haut : suit la courbe de xa a xb
               - cote droit   : ligne verticale (xb, y(xb)) vers (xb, 0)
               - bas          : axe des abscisses de xb a xa (trace par fill) */
        ...
        /* Couche 2 : zones extremes par-dessus le bleu */
