function find_last_url() {
  ...
  while (res !== 404) {
    ...
    url = "https://cdn.jsdelivr.net/gh/mnt93/JS@main/File_" + year + "_" + S + "_" + file_index1 + ".xml"
  ...
  if (file_index1) {
    url1 = "https://cdn.jsdelivr.net/gh/mnt93/JS@main/File_" + year + "_" + S + "_" + file_index1 + ".xml"
  } else {
    url1 = "";
  }
  ...
  while (res !== 404) {
    ...
    url = "https://cdn.jsdelivr.net/gh/mnt93/JS@main/File_" + year + "_" + S + "_" + file_index2 + ".js"
    var request = new XMLHttpRequest();
    request.open('GET', url, false); // `false` makes the request synchronous
    request.send(null);
    res = request.status;
  ...
  if (file_index2) {
    url2 = "https://cdn.jsdelivr.net/gh/mnt93/JS@main/File_" + year + "_" + S + "_" + file_index2 + ".js"
  } else {
    url2 = "";
  }
